                ...
                data.map((c, i) => (
                    ...
                    >
                        <img
                            ...
                            src={c.poster_path || c.background_path || c.profile_path ? `https://image.tmdb.org/t/p/original/${c.poster_path || c.background_path || c.profile_path}` : `public/no_image.jpeg`}
                            alt="" />
